...
pub struct EdgesIter<'a,NodeId,EdgeData> {
    ...
    pub(crate) to_iter: Option<(NodeId,std::collections::hash_map::Iter<'a,NodeId,EdgeData>)>,
}
...
pub struct EdgesIterMut<'a,NodeId,EdgeData> {
    pub(crate) from_iter: std::collections::hash_map::IterMut<'a,NodeId,HashMap<NodeId,EdgeData>>,
    pub(crate) to_iter: Option<(NodeId,std::collections::hash_map::IterMut<'a,NodeId,EdgeData>)>,
}
